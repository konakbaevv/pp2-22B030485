...
class Cars(pygame.sprite.Sprite):
    def __init__(self, size_of_main_screen):
        ...
        self.rand_size = random.randint(1, 5)
        self.font = pygame.font.SysFont("Verdana", 14 * self.rand_size)
        self.image_coin = self.font.render(str(self.rand_size), True, "blue")
    ...
    def coin(self):
        self.rect_coin.center = (random.randint(2, self.size_of_main_screen[0] - 15), 
                                    random.randint(2, self.size_of_main_screen[1] - 15))
    def build_coin(self, main_image):
        self.main_image = main_image
        self.main_image.blit(self.image_coin, self.rect_coin.center)
    def create_rand_coin(self):
        self.rand_size = random.randint(1, 5)
        self.font = pygame.font.SysFont("Verdana", 10 * self.rand_size)
        self.image_coin = self.font.render(str(self.rand_size), True, "blue")
        self.rect_coin = self.image_coin.get_rect()
...
pygame.mixer.music.load("13. Showdown!.mp3")
...
while True:
    ...
    if a_car.rect.colliderect(player.rect):
        ...
        main_screen.blit(score_overall, (main_screen.get_rect().center[0] - 170, main_screen.get_rect().center[1] - 100))
